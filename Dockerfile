...
COPY workspaceFolder/settings.json /home/coder/.local/share/code-server/User/settings.json
COPY workspaceFolder/file.txt /home/coder/.local/share/code-server/User/file.txt
